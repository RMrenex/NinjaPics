...
const Login = (props) => {
    ...
    var config = {
        method: 'post',
        url: 'https://data.mongodb-api.com/app/data-vavlp/endpoint/data/beta/action/findOne',
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Request-Headers': '*',
            'api-key': '1p5gGspMeoLyLU80Hh3iz3yONvAiQ5DbLpwcqwMmRzILUxw52JGj21KfPT8gtpaF'
        },
        data: data
    };
